  ...
  tags$head(
    ...
    sidebarLayout(
      ...
      sidebarPanel(
        ...
        ##buttons for choosing fusions
        radioButtons("radio6", label = h3("Calculate fusions (BETA)"),
                     choices = list("yes" = T, "no" = F), 
                     selected = F),
        
        ##buttons for displaying normal values in graphs
        radioButtons("radio5", label = h3("Display Normal Karyotypes in Graph (BETA)"),
                     choices = list("yes" = T, "no" = F), 
                     selected = F),
        hr(),
      ...
      mainPanel (
       ...
       conditionalPanel(
         ...
         tableOutput("fusiontable"),
         
         plotOutput("singleplot_fus", height="500px",width="1200px",
                    click = "plot_click",  # Equiv, to click=clickOpts(id="plot_click")
                    hover = hoverOpts(id = "plot_hover", delayType = "throttle"),
                    brush = brushOpts(id = "plot_brush"))
       ...
       conditionalPanel(
         ...
         tableOutput("fusionfiletable"),
         plotOutput("tableplot_fus", height="800px",width="1200px",
                    click = "plot_click",  # Equiv, to click=clickOpts(id="plot_click")
                    hover = hoverOpts(id = "plot_hover", delayType = "throttle"),
                    brush = brushOpts(id = "plot_brush")),
         value="File Result"
