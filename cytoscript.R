...
CytoConverter <-
  function(in_data,
    ...
    for (i in 1:nrow(Con_data))
    {
      ...
      {
        tottable <- mod_rowparser$samparse(Cyto_ref_table, ref_table, Cyto_sample, Con_data, i, guess, guess_q, orOption, constitutional, transloctable, Dump_table, sexstimate, forMtn)
